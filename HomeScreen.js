...
export default class HomeScreen extends React.Component{
  ...
  componentDidMount = async() => {
    ...
    var class_ref =await db.ref('class').on('value', data => {

      //SELECIONE A OPÇÃO CORRETA PARA LER OS DADOS DO BANCO DE DADOS
      //  var class_a = val()
      //  var class_a = data()
  ...
  updateAttendence=(roll_no, status)=> {
    ...
    today = dd + '-' + mm + '-' + yyyy;
    //SELECIONE A OPÇÃO CORRETA PARA ATUALIZAR O STATUS (PRESENTE / AUSENTE NO BANCO DE DADOS)
